 ...
 * @author usuario
 */
public class VentanaVentasGeneradas extends javax.swing.JFrame {

    private DefaultTableModel modeloTablaVentas;

    /**
     * Creates new form VentanaVentasGeneradas
     */
    public VentanaVentasGeneradas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de ingresos de cada negocio"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaVentasGeneradas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaVentasGeneradas().setVisible(true);
            }
        });
    }
